...
public class C02_MavenTest {
    public static void main(String[] args) {
       ...
       driver.findElement(By.xpath("//button[@id='signin_button']")).click();
        ...
        driver.findElement(By.xpath("(//*[text()='Pay Bills'])[1]")).click();
        ...
        WebElement mesajCıktısı=driver.findElement(By.xpath("//*[text()='The payment was successfully submitted.']"));
        if(mesajCıktısı.isDisplayed()){
